    ...
    <div class="wrapper">
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand" href="estadisticas.php">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        <a class="sidebar-link" href="estadisticas.php" style="background: #222e3c !important;">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="../c_config/config.php" style="background: #222e3c !important;">
                    ...
                    <!--
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" data-bs-toggle="dropdown">
                                <i class="align-middle" data-feather="book"></i> 
                                <span class="align-middle">Otra prueba</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end drop">
                                <a class="dropdown-item" href="c_operaciones/reporte_dia.php">
                                    <i class="align-middle me-1" data-feather="sunrise"></i> 
                                    <span>Reporte del dia</span> 
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="c_operaciones/reporte_general.php">
                        ...
                        <li class="sidebar-item active" id="estadisticas">
                            <a class="sidebar-link index-2" style="background: #222e3c;">
								<i class="align-middle" data-feather="sliders"></i>
								<span class="align-middle">Otra prueba</span>
							</a>
                            <ul class="sidebar-nav">
                                <li class="sidebar-item sidebar-item-sub" id="slidebar">
                                    <a class="sidebar-link text-black bg-white index-1" href="index.php">
                                        <i class="align-middle text-black" data-feather="sliders"></i>
                                        <span class="align-middle">Estadistica</span>
                                    </a> 
                                </li>
                                <li class="sidebar-item sidebar-item-sub" id="slidebar">
                                    <a class="sidebar-link text-black bg-white" href="index.php">
                                        <i class="align-middle text-black" data-feather="sliders"></i>
                                        <span class="align-middle">Estadistica</span>
                                    </a> 
                                </li>
