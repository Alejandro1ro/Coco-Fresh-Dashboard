...
<head>
    ...
    <link rel="stylesheet" href="asset/datatable/DataTables-1.11.5/css/dataTables.bootstrap4.min.css">
            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item" id="operaciones">
                        ...
                        <ul class="sidebar-nav">
                            <li class="sidebar-item sidebar-item-sub arreglo" id="report_ope">
                    ...
                    <li class="sidebar-item active" id="empleados">
                        <a class="sidebar-link index-2" style="background: #222e3c !important;">
                            <i class="align-middle" data-feather="user"></i>
                            <span class="align-middle">Empleados</span>
                        </a>
                        <ul class="sidebar-nav active">
                            <li class="sidebar-item sidebar-item-sub arreglo" id="report_emp">
                                <a class="sidebar-link sidebar-primary text-black bg-white index-1" href="empleados.php">
                                    <i class="align-middle me-1 text-black" data-feather="users"></i>
                                    <span class="align-middle">Lista de empleados</span>
                                </a>
                            </li>
                            <li class="sidebar-item sidebar-item-sub arreglo" id="report_emp">
                                <a class="sidebar-link sidebar-primary text-black bg-white" href="nomina.php">
