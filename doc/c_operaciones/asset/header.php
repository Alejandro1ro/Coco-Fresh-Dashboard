        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active" id="operaciones">
                        ...
                        <ul class="sidebar-nav">
                            <li class="sidebar-item sidebar-item-sub" id="report_ope">
                                <a class="sidebar-link sidebar-primary text-black bg-white index-1" href="reporte_dia.php">
                                    <i class="align-middle me-1 text-black" data-feather="sunrise"></i>
                                    <span class="align-middle">Reporte del dia</span>
                                </a>
                            </li>
                            <li class="sidebar-item sidebar-item-sub" id="report_ope">
                                <a class="sidebar-link sidebar-primary text-black bg-white" href="reporte_general.php">
