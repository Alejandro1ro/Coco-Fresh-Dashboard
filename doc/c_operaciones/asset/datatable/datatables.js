...
(function (factory) {
    ...
    function _fnFeatureHtmlFilter(settings) {
        ...
        var filter = $('<div/>', {
            ...
            class: classes.sFilter + ' text-end'
        }).append($(str));
    ...
    function _fnFeatureHtmlInfo(settings) {
        var tid = settings.sTableId,
            ...
            n = $('<div/>', {
                class: settings.oClasses.sInfo + ' text-start',
    ...
    function _fnFeatureHtmlLength(settings) {
        ...
        var div = $('<div><span/></div>').addClass(classes.sLength+' text-start');
    ...
    DataTable.defaults = {
        ...
        oLanguage: {
             ...
             *    } );
             */
            sEmptyTable: 'No se encuentras datos en la tabla',
             ...
             *    } );
             */
            sInfo: 'Mostrando de: _START_ a _END_ registros de _MAX_ ',
             ...
             *    } );
             */
            sLengthMenu: '<p>Mostrando: _MENU_ Registros</p>',
...
(function (factory) {
    ...
    $.extend(true, DataTable.defaults, {
        dom:
            ...
            "<'row overflow-auto'<'col-sm-12 min-width'tr>>" +
    ...
    DataTable.ext.renderer.pageButton.bootstrap = function (settings, host, idx, buttons, page, pages) {
        ...
        attach($(host).empty().html('<ul class="pagination" style="justify-content: flex-end !important;"/>').children('ul'), buttons);
